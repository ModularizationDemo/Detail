...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 1) {
        ...
        if (indexPath.row > 0) {
            ...
            devc.docid = self.viewModel.sameNews[indexPath.row].id;
...
- (IBAction)replyClick {
    UIViewController *replyVC = [[Lothar shared] Reply_aViewController:SXReplyFromNewsDetail photoSetId:@"" docid:self.docid boardId:self.boardid];
